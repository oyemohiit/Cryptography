...
lblInfo = Label(Tops, font=('Times New Roman', 30, 'bold'),
...
btnTotal = Button(f1, padx=16, pady=8, bd=16, fg="black",
                  font=('Georgia', 16, 'bold'), width=10,
                  text="Show Message", bg="#a93ea5",
                  command=Results).grid(row=7, column=1)

# Reset button
btnReset = Button(f1, padx=16, pady=8, bd=16,
                  fg="black", font=('Georgia', 16, 'bold'),
                  width=8, text="Reset", bg="#a7da40",
                  command=Reset).grid(row=7, column=2)

# Exit button
btnExit = Button(f1, padx=16, pady=8, bd=16,
                 fg="black", font=('Georgia', 16, 'bold'),
                 width=8, text="Exit", bg="#da2c27",
